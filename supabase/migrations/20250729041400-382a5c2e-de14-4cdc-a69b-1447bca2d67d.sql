...
('AAMUSTED Student Lodge', 'Modern student accommodation with all essential amenities. Close to campus with excellent security and study facilities.', 'Near Main Campus Gate', 'Plot 15, University Road, Sunyani', 1200.00, 400.00, 4.8, 156, 12, 50, '0.2km from campus', '{"WiFi", "Security", "Common Room", "Kitchen", "Laundry", "Study Room", "Parking"}', 'Mr. Quansah Michael', '+233 553873864', 'contact@aamustudentlodge.com', true, true),

('University Heights Hostel', 'Affordable accommodation with modern facilities. Perfect for students looking for comfort and convenience near AAMUSTED campus.', 'Sunyani Campus Area', 'Block C, University Heights, Sunyani', 950.00, 316.67, 4.5, 89, 8, 40, '0.5km from campus', '{"WiFi", "Parking", "Laundry", "Study Room", "Security", "Generator", "Water Supply"}', 'Mr. Zigli Joshua', '+233 557035169', 'nyinakujoshua998@gmail.com', true, true),

('Campus View Residence', 'Premium student accommodation offering luxury living with outstanding amenities and services for discerning students.', 'Behind Library Complex', 'Academic Area, Campus View Estate, Sunyani', 1400.00, 466.67, 4.9, 203, 5, 30, '0.1km from campus', '{"WiFi", "AC", "Generator", "Security", "Gym", "Swimming Pool", "Cafeteria", "24/7 Water", "DSTV"}', 'Dr. Nyinaku Joshua', '+233 595020929', 'joshuanyinaku48@gmail.com', true, true),

('Green Valley Hostel', 'Eco-friendly student accommodation with solar power and green spaces. Affordable rates with excellent facilities.', 'Abesim Junction', '23 Green Valley Road, IPT, Kumasi', 800.00, 266.67, 4.2, 67, 15, 35, '1.2km from campus', '{"WiFi", "Solar Power", "Garden", "Security", "Study Hall", "Kitchen", "Borehole Water"}', 'Mr. Joseph Boateng', '+233 204317700', 'greenvalley@gmail.com', true, true),

('Royal Student Palace', 'Luxurious accommodation with modern amenities and excellent service. Perfect for students who value comfort and style.', 'Fiapre Road', 'Royal Estate, Apatrapa Road, Kumasi', 1600.00, 533.33, 4.7, 134, 7, 25, '0.8km from campus', '{"WiFi", "AC", "Elevator", "Security", "Housekeeping", "Restaurant", "Conference Room", "Backup Generator"}', 'Princess Adwoa Serwaa', '+233 20 333 4444', 'info@royalpalace.com.gh', true, true),

('Authonomy Hall', 'Budget-friendly accommodation with basic amenities. Clean and safe environment for students on a tight budget.', 'Tanoso', 'Harmony Street,AAMUSTED-K Campus,Kumasi', 650.00, 216.67, 3.9, 45, 20, 60, '1.8km from campus', '{"WiFi", "Security", "Common Kitchen", "Study Area", "Water Supply", "Shared Bathroom"}', 'Mr. Isaac Owusu', '+233 24 999 1111', 'harmonyhall@yahoo.com', true, true);
